  ...
  return (
    <div className="px-8 xl:px-32 py-18 bg-[#99e54d]">
      <div className="bg-white rounded-4xl flex flex-col items-center gap-6 py-10">
        <div>
            <h2 className="text-xl sm:text-2xl md:text-4xl font-bold">Keep up to date with us</h2>
        </div>
        <div>
        ...
        <div className="flex items-center">
            ...
            <p className="text-xl font-bold sm:text-2xl md:text-4xl"> +1 (234) 567-8910</p>
        </div>
      </div>
    </div>
  )
