...
function Contact() {
    return (
        <div className="px-8 xl:px-32 bg-[#f9f6ee] py-12">
            <div className="flex flex-col gap-8 bg-white rounded-4xl px-2 py-8 md:px-8 lg:flex-row lg:justify-around">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4 md:flex-row md:mt-10">
                        <div className="h-16 w-16 flex justify-center items-center bg-green-400 rounded-[50%]">
